...
/**
 * Servlet implementation class DeleteChose
 */
@WebServlet("/DeleteChose")
public class DeleteChose extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int num=-1;
		String sql="delete from chose where id = '"+chose+"';";
		System.out.println(sql);
		num=DBO.updata(sql);
		sql="delete from paper where chose = '"+chose+"';";
		DBO.updata(sql);
		if(num<=0) {
